...
public class PrimalIridiumDrillingCrusher extends ItemTool implements IElectricItem {

    public PrimalIridiumDrillingCrusher() {
    ...
    public void getSubItems(CreativeTabs tab, NonNullList<ItemStack> items) {
        if (this.isInCreativeTab(tab)) {
            ...
            EnumInfusionEnchantment.addInfusionEnchantment(item, EnumInfusionEnchantment.DESTRUCTIVE, 1);
